     ...
     function onRequest(context) {
         ...
         resultSet.each( function(searchResult, index) {
             ...
             if (commRegCount == 0) {
                 ...
                 inlineQty += '<tr><td></td><td><a href="' + baseURL + '/app/common/entity/custjob.nl?id=' + custid + '"><p style="text-align:left;">' + entityid + '</p></a></td><td ><p style="text-align:left;">' + companyname + '</p></td><td><div class="row"><div class="col-sm-6"><button type="button" class="commRegUpload btn btn-block btn-secondary" disabled> DuplicateCOMMREG </button></div><div class="col-sm-6"><input type="button" id="cancel_customer_'+custid+'" class="form-control btn-danger cancel_customer" value="COVID CANCEL"></div></div></td></tr>';
